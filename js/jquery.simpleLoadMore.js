...
(function($) {
  $.fn.simpleLoadMore = function( options ) {
    ...
    $loadMore.each(function(i, el) {
      ...
      var btnHTML       = settings.btnHTML ? settings.btnHTML : '<a href="" id="loadmore" class="cu_btn base_btn load_more_btn">See more products <i class="fas fa-chevron-down"></i></a>';
      var $btnHTML      = $(btnHTML);
